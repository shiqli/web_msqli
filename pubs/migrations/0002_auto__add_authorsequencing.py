...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuthorSequencing'
        db.create_table(u'pubs_authorsequencing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pubs.Author'])),
            ('publication', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pubs.Publication'])),
            ('author_rank', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'pubs', ['AuthorSequencing'])
    ...
    def backwards(self, orm):
        # Deleting model 'AuthorSequencing'
        db.delete_table(u'pubs_authorsequencing')
    ...
    models = {
        ...
        u'pubs.authorsequencing': {
            'Meta': {'object_name': 'AuthorSequencing'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pubs.Author']"}),
            'author_rank': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publication': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pubs.Publication']"})
        },
        u'pubs.book': {
        ...
        u'pubs.publication': {
            ...
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pubs.Author']", 'through': u"orm['pubs.AuthorSequencing']", 'symmetrical': 'False'}),
